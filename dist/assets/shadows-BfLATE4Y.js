import{A as c,f as u,j as e,G as o,M as d,S as s,T as n,i,P as r}from"./index-5nELRKNd.js";import{C as m,a as g}from"./ComponentSkeleton-7YH015nb.js";const t=[`INVESTMENT OWNER’S CONTRACT : 
...
_____________ ___________________`,`Page 2: Rule 1: Never Lose Money 
 ...
 Rule 12: Don’t Be Foolish`,"Page 3: To the extent we have been successful, it is because we concentrated on identifying one-foot hurdles that we could step over rather than because we acquired any ability to clear seven-footers. — Warren Buffett","Page 4: The individual investor should act consistently as an investor and not as a speculator. — Ben Graham","Page 5: To achieve satisfactory investment results is easier than most people realize; to achieve superior results is harder than it looks"];function f(){c();const[_,a]=u.useState(0),l=()=>{_<t.length-1&&a(_+1)},h=()=>{_>0&&a(_-1)};return e.jsx(m,{children:e.jsx(g,{children:e.jsx(o,{container:!0,spacing:3,children:e.jsx(o,{item:!0,xs:12,children:e.jsx(d,{children:e.jsxs(s,{spacing:2,justifyContent:"center",alignItems:"center",children:[e.jsx(n,{variant:"h4",children:"Book Title : Intelligent Investor"}),e.jsx(n,{variant:"subtitle1",children:"Author Name : BEN"}),e.jsx(n,{variant:"body1",sx:{margin:2},children:t[_]}),e.jsxs(s,{direction:"row",spacing:2,children:[e.jsx(i,{variant:"contained",color:"primary",onClick:h,disabled:_===0,children:"Previous"}),e.jsx(i,{variant:"contained",color:"primary",onClick:l,disabled:_===t.length-1,children:"Next"})]})]})})})})})})}f.propTypes={page:r.number,setPage:r.func};export{f as default};
